 ...
 */
#[Fillable(['name', 'email', 'password', 'username', 'avatar_path', 'role', 'headline', 'bio', 'location', 'timezone', 'github_url', 'website_url', 'linkedin_url', 'is_admin', 'suspended_at', 'public_passport', 'feed_layout', 'onboarding_completed_at', 'credit_balance', 'daily_evidence_count', 'daily_evidence_date', 'is_verified', 'verified_at', 'short_domain', 'auto_scan_enabled', 'auto_scan_active_until', 'last_auto_scan_at'])]
...
class User extends Authenticatable implements PasskeyUser, WirechatUser
{
    ...
    public function canAccessWirechatPanel(Panel $panel): bool
    {
        ...
        return $this->isVerified() && ! $this->suspended_at;
    }
