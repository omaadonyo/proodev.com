...
class Company extends Model
{
    ...
    {
        // Only Intelligence Suite is unlimited. Trial and Recruiter are limited
        // to their purchased job post credits (1 active post each by default).
        if ($this->plan === CompanyPlan::Intelligence) {
            return false;
        }
