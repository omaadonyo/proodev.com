...
class ImportScoutedReposJob implements ShouldQueue
{
    ...
    public function handle(OnboardingImportService $import, ScanEmailBatcher $batcher): void
    {
        ...
        // Background imports are summarized in a single completion email
        // instead of one email per scanned item.
        $batcher->begin($user, 'Background scan');
