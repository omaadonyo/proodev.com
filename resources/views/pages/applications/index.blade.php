...
<div class="mx-auto w-full max-w-3xl">
    <div class="grid gap-6">
        <div>
            ...
            <flux:text>Track every role you've applied to with your passport.</flux:text>
        </div>
        ...
        <div class="grid gap-3">
            ...
            @empty
                <div class="rounded-xl border border-dashed border-zinc-300 p-12 text-center dark:border-zinc-600">
                    ...
                    <flux:text class="mt-2">Browse open roles and apply with your evidence-backed passport.</flux:text>
