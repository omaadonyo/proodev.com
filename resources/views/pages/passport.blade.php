...
new #[Title('Passport')] class extends Component
{
    use WithPagination;
    ...
    public function mount(User $user): void
    {
        ...
        $this->user = $user;
        app(PassportViewService::class)->record($user, auth()->user(), request()->ip());
    }

    #[Computed]
    public function viewCount(): int
    {
        return app(PassportViewService::class)->count($this->user);
    }

    #[Computed]
    public function recentViewers()
    {
        return app(PassportViewService::class)->recentViewers($this->user, 12);
    }
