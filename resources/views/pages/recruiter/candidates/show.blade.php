...
<div class="grid gap-6">
    <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <a href="{{ route('devid', $this->report['developer']['handle']) }}" wire:navigate class="inline-flex h-8 items-center gap-1.5 rounded-lg bg-zinc-100 px-3 text-sm font-medium text-zinc-700 transition hover:bg-zinc-200 dark:bg-white/10 dark:text-zinc-200 dark:hover:bg-white/15">
                Public DevID
            </a>
        </div>
    </div>
            ...
            <div class="rounded-xl bg-zinc-100 p-5 dark:bg-white/5">
                ...
                <div class="mt-2 flex flex-wrap gap-1.5">
                    @forelse (array_slice($this->report['evidence']['technologies'], 0, 12) as $tech)
                        <span class="rounded-full bg-zinc-100 px-2.5 py-0.5 text-xs dark:bg-white/10">{{ $tech }}</span>
                    @empty
