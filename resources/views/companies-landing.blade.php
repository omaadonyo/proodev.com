            ...
            <div id="preview" class="relative mx-auto mt-14 max-w-5xl" x-data="companySearch()">
                ...
                <div class="overflow-hidden rounded-2xl border border-zinc-200 bg-white/90 shadow-2xl shadow-zinc-900/10 backdrop-blur-xl dark:border-white/10 dark:bg-zinc-950/80">
                    ...
                    <div class="border-b border-zinc-200 px-5 py-3 dark:border-white/5">
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <button type="button" @click="verifiedOnly = !verifiedOnly"
                                ...
                                class="inline-flex h-9 shrink-0 items-center gap-1.5 rounded-full border px-3 text-xs font-semibold transition">
                            ...
                            <span class="hidden shrink-0 items-center gap-1.5 rounded-full border border-zinc-200 bg-white px-3 py-2 text-xs font-medium text-zinc-500 sm:inline-flex dark:border-white/10 dark:bg-white/5 dark:text-zinc-400">
                        ...
                        <div class="mt-3 flex flex-wrap items-center gap-2">
                            ...
                            @foreach ($skillFilters as $skill)
                                <button
                                    ...
                                    class="inline-flex h-8 shrink-0 items-center gap-1.5 rounded-full border px-3 text-xs font-medium transition"
                                >
                    ...
                    <div class="p-5">
                        ...
                        {{-- Post-filter actions — Export PDF enabled with blurred preview, rest locked --}}
                        <div class="mt-3 rounded-xl border-2 border-amber-300 bg-amber-50/60 p-3 shadow-sm shadow-amber-500/10 dark:border-amber-500/30 dark:bg-amber-500/10">
                            ...
                            <div class="mt-3 flex flex-wrap gap-2">
                                ...
                                @foreach ([
                                    ...
                                    ['label' => 'Save Search & Alert', 'icon' => 'bell-alert'],
                                    ['label' => 'Share results', 'icon' => 'arrow-right'],
                                ] as $action)
                                    <a href="{{ route('register', ['role' => 'company']) }}" class="group inline-flex items-center gap-1.5 rounded-full border border-zinc-200 bg-white px-3 py-1.5 text-xs font-semibold text-zinc-600 opacity-60 transition hover:opacity-100 dark:border-white/10 dark:bg-white/5 dark:text-zinc-300">
                                ...
                                @foreach ([
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            @if ($row['theirs'])
                                                <span class="mx-auto inline-block size-2.5 rounded-full bg-emerald-500"></span>
                                            @else
                                                <span class="mx-auto inline-block size-2.5 rounded-full bg-red-400"></span>
                                            @endif
                                        </td>
                                        <td class="px-4 py-3 text-center">
                                            <span class="mx-auto inline-block size-2.5 rounded-full bg-emerald-500"></span>
        ...
        <section id="tools" class="section-contained relative overflow-hidden border-t border-zinc-200 dark:border-white/5">
            <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <div class="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ([
                        ['icon' => 'magnifying-glass', 'title' => 'Evidence-based search', 'text' => 'Search against analyzed work, not self-reported keywords. Grid, list, or avatar views.'],
                        ['icon' => 'document-text', 'title' => 'Candidate intelligence', 'text' => 'Every candidate gets an evidence-backed report with technologies, strengths, and magnitude score.'],
                        ['icon' => 'scale', 'title' => 'Side-by-side comparison', 'text' => 'Stack candidates and compare across evidence, verification, and community signals.'],
                        ['icon' => 'shield-check', 'title' => 'Verified network', 'text' => 'Filterable pool of engineers who passed official verification. Proven, not claimed.'],
