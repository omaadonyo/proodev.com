...
>
    ...
    >
        ...
        <div class="grid max-h-96 overflow-y-auto overflow-x-hidden">
            @forelse ($this->recent as $notification)
                <a
                    href="{{ route('notifications') }}"
                    wire:navigate
                    wire:click="markAsRead('{{ $notification->id }}')"
                    class="flex items-start gap-3 overflow-hidden px-4 py-3 transition hover:bg-zinc-50 dark:hover:bg-zinc-950/50"
                >
                    ...
                    <span class="min-w-0 flex-1 overflow-hidden">
                        ...
                        <span class="block break-words text-xs text-zinc-500 line-clamp-2 overflow-hidden">{{ $notification->data['body'] ?? '' }}</span>
                    </span>
