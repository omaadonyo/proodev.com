    ...
    <ul class="mt-5 grid gap-2 text-sm text-zinc-600 dark:text-zinc-300">
        @foreach ($items as $item)
            <li class="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-4 shrink-0 text-emerald-500"><path fill-rule="evenodd" d="M4.5 12.75l6 6 9-13.5" clip-rule="evenodd"/></svg>
                {{ $item }}
            </li>
        @endforeach
    </ul>
