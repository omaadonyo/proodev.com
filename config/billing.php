...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Verification is a one-time $8 purchase that grants a badge and a
    | proo.dev/<name> short link. Credits power AI link analyses beyond the
    | free daily allowance. One credit = tokens_per_credit tokens and covers
    | roughly one analysis (1 credit = 1000 tokens, 1 credit per link).
    |
    */
